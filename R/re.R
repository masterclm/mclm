...
#    re()                # constructor 
#    print.re()          # S3 Method
#    plot.re()           # S3 Method (stub)
#    summary.re()        # S3 Method
#    print.summary.re()  # S3 Method
#    plot.summary.re()   # S3 Method (stub)
#    perl_flavor
#    perl_flavor<-

#    as.character.re()   # S3 Method
#    as_character.re()   # S3 Method
...
# --
# everything below this point need thorough testing
# --
